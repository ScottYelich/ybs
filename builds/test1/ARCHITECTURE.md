...
- Original spec reference: `../../docs/misc/yds-spec.md` (matches Swift-specific design)
- Architectural decisions: `../../docs/misc/yds-decisions.md` (aligns with D01 - Swift choice)
