...
- Original spec reference: `../../docs/yds-spec/yds-spec.md` (was Swift-specific, adapt as needed)
- Architectural decisions: `../../docs/yds-spec/yds-decisions.md` (reference but adapt)
```
